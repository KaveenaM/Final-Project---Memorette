    ...
    <div class="row">
      ...
      <div class="col-sm-4">
        ...
        <div class="panel panel-default"  id="id" style="background-color:#ffe6ff;">
          ...
          <div class="panel-heading" align="center" style="color:#330033;">
            <b><?php echo $row["item_name"]; ?></b>
          </div>

          <div class="panel-body">
            <?php echo '<img src="data:image/jpeg;base64,'.base64_encode($row['item_photo'] ).'" height="220px" width="200px" class="img-thumnail" />'?>
          </div>
