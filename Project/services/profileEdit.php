...
<?php
    ...
    if(isset($_POST['submit'])){
        ...
        if(mysqli_query($conn,$sql)){
            echo " <script type='text/javascript'>alert('Profile Updated!!!');location.href='profileEdit.php'</script>";                      
        }else{
            echo " <script type='text/javascript'>alert('Error Updated!!!');location.href='profileEdit.php'</script>";  
        }
        mysqli_close($conn);
    }
?>
...
<body>
    ...
    <form method='POST' border=5px action="">
        <div class="modal-body mx-4" style="font-family:Arial, Helvetica, sans-serif;font-size:20px;">
            ...
            <div align=center>
                <table>
                    ...
                    <tr>
                        ...
                        <td class="td1"><input type="text" value="<?php echo $itemdata[1];?>" name="fname" required></td>
                    </tr>

                    <tr>
                        <td class="td">Last name</td>
                        <td class="td1"><input type="text" value="<?php echo $itemdata[2];?>" name="lname" required></td>
                    </tr>

                    <tr>
                        <td class="td">Email<span class="required">*</span></td>
                        <td class="td1"><input type="email" value="<?php echo $itemdata[3];?>" name="email" required></td>
                    </tr>

                    <tr>
                        <td class="td">Phone Number<span class="required">*</span></td>
                        <td class="td1"><input type="text" value="<?php echo $itemdata[4];?>" name="contact" minlength= "10" maxlength = "10"required></td>
                    </tr>

                    <tr>
                        <td class="td">Address<span class="required">*</span></td>
                        <td class="td1"><input type="text" value="<?php echo $itemdata[5];?>" name="address" required></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="td">
                            <table>  
                                ...
                                <tr>
                                    <P>
                                        <span class="required">*</span><b> Required fields </b>
                                    </P>
                                </tr>
                            </table>
                        </td> 
