    ...
    <form method="post" enctype="multipart/form-data">  
        <table border="1"  >
            ...
            <?php 
                ...
                $sql = "SELECT * FROM item_designs WHERE design_id='".$_GET['id']."'";
                ...
                <div class="row" >
                    ...
                    <div class="panel panel-default"  id="id">
                        ...
                        <div class="panel-body"><?php echo ' 
                                            <img src="data:image/jpeg;base64,'.base64_encode($row['design_photo'] ).'" height="150" width="150" class="img-thumnail" />'?></div>
                        <div class="price" >
                        ...
                        <button onclick="location.href='customerIndex.php'" type="button" class="btn btn-dark" style="background-color:#00134d;color:white;margin:10px;width:100px;">Back</button>
                        <button onclick="location.href='designOrder.php ?id=<?php echo $row['design_id']; ?>'" type="button" class="btn btn-dark" style="background-color:#00134d;color:white;margin:10px;width:100px;">Buy Now</button><br><br>
                    </div>
                    </div>
                </div>
            <?php
