...
$sql="UPDATE customer_requests
    ...
    if(mysqli_query($conn,$sql)){
        echo " <script type='text/javascript'>alert('Request Confirmed!!!');location.href='customerRequests.php'</script>";                                       
    }else{
        echo " <script type='text/javascript'>alert('error Confirm!!!');location.href='customerRequests.php'</script>";
    }
    mysqli_close($conn);
}
?>
...
<div class="content">
    ...
    <table  border="1"align=center id="myTable"  style="width:60%;" cellpadding="10" >
        ...
        <tr>
            <td></td>                
            <td align="right" ><button <?php if ($itemdata[10] != 1){ ?> disabled <?php } ?> type="submit" class="btn btn-dark" style="background-color:green;color:white;margin:10px">Confirm</button>
