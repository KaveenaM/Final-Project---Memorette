        ...
        <ul>
            ...
            <li>
                <div class="text-center">
                    <a href="" data-toggle="modal" data-target="#eForm1">| Add Customer</a>
                </div>
            </li>
        </ul>
    </div>
    ...
    <div class="modal fade" id="eForm1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content form-elegant">
                ...
                <form method="POST" action="management/addCustomer.php" enctype="multipart/form-data">
    ...
    <div class="content">
        <table border="1" align=center id="myTable">
            ...
            <?php  
                ...
                $sql2 = " SELECT * FROM users where user_type = 4" ;  
            ...
            <tr>  
                ...
                <td>  
                    <a onClick="javascript: return confirm('Are you sure want to Update?');" href="management/customerUpdate.php ?id=<?php echo $row['user_id'];?>" class="btn btn-dark" type="button" style="background-color:green;color:white;margin:10px"> Update </a>
                    <a onClick="javascript: return confirm('Are you sure want to Delete?');" href="management/customerDelete.php ?id=<?php echo $row['user_id'];?>" class="btn btn-dark" type="button" style="background-color:red;color:white;"> Delete </a> 
                </td>        
            </tr> 
