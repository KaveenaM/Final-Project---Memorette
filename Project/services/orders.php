<?php session_start();
    ...
    $sql1="SELECT * FROM items WHERE item_id='".$_GET['id']."'";
    ...
    if(isset($_POST['quantity'])){
        ...
        $sql2="INSERT INTO temp_orders(item_id,user_id,order_count,total_price,paymentslip_photo,payment_date) 
            VALUES('".$data['item_id']."','".$data4['user_id']."','".$_POST['quantity']."','".$Total."','".$img."',now())"; 

        $sql5="UPDATE items SET item_count = item_count - $count WHERE item_id = '".$_GET['id']."'";  
        $sql6 ="UPDATE item_designs SET item_count = item_count - $count WHERE item_id = '".$_GET['id']."'";  
...
<body style="color:#002080;font-family:Arial, Helvetica, sans-serif;font-size:50px;">
    ...
    <h1 align=center>Review Item And Deliver :</h1>
        <table align="center"  id="myTable" style="width:50%;" >
            <tr>
                <td>
                    <?php echo '<img src="data:image/jpeg;base64,'.base64_encode($data['item_photo'] ).'" height="150" width="150" class="img-thumnail" />'?> 
                </td>
            </tr>
            <tr>
