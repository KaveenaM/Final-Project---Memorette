            ...
            ?>  
                ...
                <div class="row" >
                    ...
                    <div class="panel panel-default"  id="id">
                        ...
                        <button onclick="location.href='customer/customerIndex.php'" type="button" class="btn btn-dark" style="background-color:#00134d;color:white;margin:10px;width:100px;">Back</button>
                        <button onclick="location.href='customer/designs.php ?id=<?php echo $row['item_id'];?>'" type="button" class="btn btn-dark" style="background-color:#00134d;color:white;margin:10px;width:100px;">Designs</button>
                        <button onclick="location.href='orders.php ?id=<?php echo $row['item_id']; ?>'" type="button" class="btn btn-dark" style="background-color:#00134d;color:white;margin:10px;width:100px;">Buy Now</button><br><br>
                    </div>
                    </div>
                </div>
            <?php
