          ...
          ?>  
              <tr>  
                  ...
                  <td> 
                    ...
                    <a onClick="javascript: return confirm('Are you sure want to Delete?');" href="itemDelete.php ?id=<?php echo $row['item_id'];?>" class="btn btn-dark" type="button" style="background-color:red;color:white;">Delete </a> 
                 </td>
              </tr> 
          <?php
          } } else{
