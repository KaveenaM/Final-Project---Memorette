    ...
    if(isset($_POST['fname'])){
        ...
        $sql="UPDATE users
            ...
            if(mysqli_query($conn,$sql)){
                echo " <script type='text/javascript'>alert('Update Success!!!');location.href='../customerManagement.php'</script>";                             
            }else{
                echo " <script type='text/javascript'>alert('error Update!!!');location.href='../customerManagement.php'</script>";         
            }
        mysqli_close($conn);
    }
?>
        ...
        <div align=center>
            <table>
                ...
                <tr>
                    ...
                    <td class="td1"><input type="text" value="<?php echo $itemdata[1];?>" name="fname" required pattern="[A-Za-z].{4,}" title="Minimum 05 Characters"></td>
                </tr>

                <tr>
                    <td class="td">Last name</td>
                    <td class="td1"><input type="text" value="<?php echo $itemdata[2];?>" name="lname"  pattern="[A-Za-z].{4,}" title="Minimum 05 Characters"></td>
                </tr>
                
                <tr>
                    <td class="td">Email<span class="required">*</span></td>
                    <td class="td1"><input type="email" value="<?php echo $itemdata[3];?>" name="email" required pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" title="Ex:- test@gmail.com"></td>
                </tr>

                <tr>
                    <td class="td">Phone Number<span class="required">*</span></td>
                    <td class="td1"><input type="text" value="<?php echo $itemdata[4];?>" name="contact" required pattern="[0-9]{10}" title="Ex:- 0771234567"></td>
                </tr>

                <tr>
                    <td class="td">Address<span class="required">*</span></td>
                    <td class="td1"><input type="text" value="<?php echo $itemdata[5];?>" name="address" required pattern="[A-Za-z].{4,}" title="Minimum 05 Characters"></td>
                </tr>
