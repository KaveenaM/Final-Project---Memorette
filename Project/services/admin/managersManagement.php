        ...
        <ul>
            ...
            <li>
                <div class="text-center">
                    <a href="" data-toggle="modal" data-target="#eForm1"> | Add Managers</a>
                </div>
            </li>
                ...
                <form method="POST" action="addManager.php" enctype="multipart/form-data">
                    <div class="modal-body mx-4" style="background-color:#330033;color:white;font-family:Arial, Helvetica, sans-serif;font-size:20px;">
                        ...
                        <div class="md-form mb-5">
                            ...
                            <input type="text" name="fname" class="form-control validate" placeholder="Enter First Name" required pattern="[A-Za-z].{4,}" title="Minimum 05 Characters" style="background-color:#bfbfbf;color:black;">
                        </div>
                        ...
                        <div class="md-form mb-5">
                            <label>Email :</label>
                            <input type="text" name="email" class="form-control validate" placeholder="Enter Email" required pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" title="Ex:- test@gmail.com"  style="background-color:#bfbfbf;color:black;">
                        </div>
    ...
    <div class="content">
        <table border="1" align=center id="myTable">
            ...
            <?php  
                ...
                $sql2 = " SELECT * FROM users where user_type = 2" ;  
            ...
            <tr>  
                ...
                <td>
                    <a onClick="javascript: return confirm('Are you sure want to Update?');" href="managersUpdate.php ?id=<?php echo $row['user_id'];?>" class="btn btn-dark" type="button" style="background-color:green;color:white;margin:10px"> Update </a>
                    <a onClick="javascript: return confirm('Are you sure want to Delete?');" href="managersDelete.php ?id=<?php echo $row['user_id'];?>" class="btn btn-dark" type="button" style="background-color:red;color:white;"> Delete </a>   
                </td>           
            </tr> 
            <?php
                    } 
