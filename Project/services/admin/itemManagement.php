            ...
            function Export() {
                html2canvas(document.getElementById('myDiv'), {
                    onrendered: function (canvas) {
                        ...
                        pdfMake.createPdf(docDefinition).download("My Item List" + new Date().toISOString().replace(/[\-\:\.]/g, "") + ".pdf");
                    }
                });
            }
        </script>
    ...
    <table border="1" align=center id="myTable">
          ...
          ?>  
              <tr>  
                  ...
                  <td><button onclick="location.href='../management/itemUpdate.php ?id=<?php echo $row['item_id'];?>'" type="button" class="btn btn-dark" style="background-color:green;color:white;margin:10px">Update</button>
                  <button onclick="location.href='../management/itemDelete.php ?id=<?php echo $row['item_id'];?>'" type="button" class="btn btn-dark" style="background-color:red;color:white;">Delete</button></td>
