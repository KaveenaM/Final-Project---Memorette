    ...
    if(isset($_POST['fname'])){
        ...
        $sql="UPDATE users
            ...
            if(mysqli_query($conn,$sql)){
                echo " <script type='text/javascript'>alert('Update Success!!!');location.href='managersManagement.php'</script>";            
            }else{
                echo " <script type='text/javascript'>alert('error Update!!!');location.href='managersManagement.php'</script>";     
            }
        mysqli_close($conn);
