...
<body>
  ...
  <div class="header" id="myHeader">
    ...
    <ul>
        ...
        <li><a href=finishedRequests.php>| Finished</a></li>
        ...
        <form method="POST" action="addNewRequest.php" enctype="multipart/form-data">
            <div class="modal-body mx-4" style="background-color:#330033;color:white;font-family:Arial, Helvetica, sans-serif;font-size:20px;">
                ...
                <div class="md-form mb-5">
                    ...
                    <input type="color" name="ccolor" value="#ff0000" class="form-control validate" style="background-color:#bfbfbf;color:black;">
                </div>

                <div class="md-form mb-5">
                    <label>Text</label>
                    <textarea name="texture" class="form-control validate" style="background-color:#bfbfbf;color:black;" required>Enter text here...</textarea>             
                </div>
                ...
                <div class="md-form mb-5">
                    ...
                    <input type="color" name="fcolor" value="#ff0000" class="form-control validate" style="background-color:#bfbfbf;color:black;">
                </div>
    ...
    <table border="1" align=center id="myTable">
          ...
          $sql2 = " SELECT * FROM customer_requests where request_status=1";  
          ...
          ?>  
              <tr>  
                  ...
                  <a onClick="javascript: return confirm('Are you sure want to Reject?');" href="requestDelete.php ?id=<?php echo $row['request_id'];?>" class="btn btn-dark" type="button" style="background-color:red;color:white;"> Reject </a> </td>
