    ...
    <div class="content">
        ...
        function Export() {
            html2canvas(document.getElementById('myDiv'), {
                onrendered: function (canvas) {
                    ...
                    pdfMake.createPdf(docDefinition).download("<?php echo date("Y-m-d")." ".date("l") ?>" + new Date().toISOString().replace(/[\-\:\.]/g, "") + ".pdf");
                }
            });
        }
      </script>
      ...
      <div id="myDiv">
        <div class="content">
          ...
          <form method='POST' >
            <h1 align='center'> Daily Order Report </br> <?php echo date("Y-m-d")." ".date("l") ?> </h1>
              ...
              <?php  
                ...
                $sql2 = " SELECT * FROM orders WHERE order_status = 2 AND order_date = CURDATE();" ;  
