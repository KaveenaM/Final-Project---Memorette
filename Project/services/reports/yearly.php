    ...
    <div class="content">
            ...
            function Export() {
                html2canvas(document.getElementById('myDiv'), {
                    onrendered: function (canvas) {
                        ...
                        pdfMake.createPdf(docDefinition).download("<?php echo date("Y"); ?> Report" + new Date().toISOString().replace(/[\-\:\.]/g, "") + ".pdf");
                    }
                });
            }
        </script>
        ...
        <div id="myDiv">
            ...
            <div class="content">
                ...
                <form method='POST' >
                    <h1 align='center'>Yearly Order Report </br> <?php echo date("Y"); ?> </h1>
                    <table border="1" align=center id="myTable">
                        ...
                        <?php  
                            ...
                            $sql2 = " SELECT * FROM orders WHERE order_status = 2 AND  YEAR(order_date) = YEAR(CURDATE());" ;
