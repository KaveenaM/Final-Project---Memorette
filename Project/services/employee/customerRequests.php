    ...
    <table border="1" align=center id="myTable">
          ...
          ?>  
              <tr>  
                  ...
                  <td>
                    <button onclick="location.href='viewRequest.php ?id=<?php echo $row['request_id'];?>'" type="button" class="btn btn-dark" style="background-color:green;color:white;margin:10px">View</button>
                    <a onClick="javascript: return confirm('Are you sure want to Reject?');" href="requestDelete.php ?id=<?php echo $row['request_id'];?>" class="btn btn-dark" type="button" style="background-color:red;color:white;"> Reject </a> 
                 </td>
